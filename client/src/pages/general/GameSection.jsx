  ...
  return (
    <div className="bg-[#EB9721] w-full px-5 relative min-h-screen">
      <div className="bg-[#EBCEA8] w-full px-5">
        ...
        {/* Videos Section */}
        <section className="p-8 min-h-[60vh] grid grid-cols-1 md:grid-cols-3 gap-6 items-start px-[20vh]">
          {filteredVideos.length > 0 ? (
            ...
            <div className="col-span-3 flex flex-col items-center justify-center min-h-[45vh]">
              <p className="text-2xl text-gray-600 font-semibold">No videos available</p>
              <p className="text-gray-500 mt-2">
                {searchQuery ? "No videos match your search criteria." : "Please check back later for new content."}
              </p>
            </div>
          )}
        </section>

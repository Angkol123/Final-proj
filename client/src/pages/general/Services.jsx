      ...
      <div className='bg-[#EBCEA8] w-[100%] h-auto p-9'>
        <div className='flex w-full h-[25vh] p-5 gap-9'>
          ...
          <div className='w-[85%] h-full p-5'>
            <p >Why Choose Us</p>
            <h2 className='text-center text-[1.5rem]'>We offer a unique educational experience tailored to young learners</h2>
        ...
        <div className='grid grid-cols-3 grid-rows-2 gap-9 p-5'>
          <div className='h-[25vh]'>
            ...
            <div className='bg-white border-[#EB9721] border p-9 h-[80%] mt-5 rounded-lg'>
          ...
          <div>
            ...
            <div className='bg-white border-[#EB9721] border p-9 h-[80%] mt-5 rounded-lg flex items-center'>
